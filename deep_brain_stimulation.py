...
#  ======= The Module ========
class deep_brain_stimulation_Module(ScriptedLoadableModule):
    ...
    def __init__(self, parent):
        ...
        self.parent.contributors = ["Caroline Essert (University of Strasbourg), Mubarak Olaoluwa (Master Student)"] 
...
class deep_brain_stimulation_Widget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def __init__(self, parent=None):
        ...
        self.logic = deep_brain_stimulation_Logic()
...
class deep_brain_stimulation_Logic(ScriptedLoadableModuleLogic):
...
class deep_brain_stimulation_Test(ScriptedLoadableModuleTest):
    """
    ...
    def test_Module(self):
        ...
        # get the logic
        logic = deep_brain_stimulation_Logic()
